      ...
      <div className="flex-shrink-0 p-4">
        <div className="flex items-center justify-between mb-5 ml-3">
          ...
          <div className="flex items-center gap-1">
            <Button
              ...
              className="hidden md:flex p-2 h-12 w-12 bg-transparent hover:bg-white/10 text-white/70 hover:text-white rounded-md"
            >
              <svg
                width="20"
                height="20"
                ...
                xmlns="http://www.w3.org/2000/svg"
                data-rtl-flip=""
                className="icon max-md:hidden text-white"
              >
        ...
        <div className="space-y-2">
          <Button
            ...
            className="w-full h-full bg-transparent hover:bg-white/10  flex items-center justify-between gap-3 px-4 rounded-lg"
          >
            <div className="flex items-center gap-3">
              ...
              <span
                className="text-[#FEFEFE] leading-[22px] font-semibold"
                style={{
                  fontFamily: "ui-sans-serif, -apple-system, system-ui",
                  fontSize: "17px",
                }}
            ...
            {isLoading ? (
              <div className="p-4">
                <div className="flex items-center justify-center py-8">
                  <div className="animate-spin w-6 h-6 border-2 border-neutral-600 border-t-white rounded-full"></div>
                </div>
              </div>
        ...
        {isCollapsed ? (
          <div className="flex flex-col h-full p-2">
            <div className="flex-shrink-0 mb-4">
              ...
              <Button
                onClick={handleToggleCollapse}
                className="w-full p-2 h-10 bg-transparent hover:bg-white/10 text-white/70 hover:text-white rounded-md mb-2"
